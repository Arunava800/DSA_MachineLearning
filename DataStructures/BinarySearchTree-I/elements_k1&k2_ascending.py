...
k1:6 , k2: 10
Sample output: 6 7 8 10( ascending order)
"""
...
def elements_range(root, k1, k2):
    if root is None:
        return None
    if root.data > k2:
        elements_range(root.left, k1, k2)
    elif root.data < k1:
        elements_range(root.right, k1, k2)
    else:
        elements_range(root.left, k1, k2)
        print(root.data, end=" ")
        elements_range(root.right, k1, k2)
...
elements_range(root_tree, element_1, element_2)
